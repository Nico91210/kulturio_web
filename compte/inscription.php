...
<div class="flexbox-inscription">
        <div class="flexbox-div-inscription">
            <br/>
            <h1 style="color: white;">Inscription</h1>
            <br/>
    <form action="../bdd/compte/insert_compte.php" method="post">
    <?php
    if(isset($_GET["Erreur"])){
        if($_GET["Erreur"] === "Pseudo"){?>
            <p style="color: white;">Ce Pseudo existe déjà</p><br/>
<?php    }  if($_GET["Erreur"] === "Email"){?>
            <p style="color: white;">Cette Email existe déjà</p><br/>
<?php    }
    }
    ?>
    &nbsp;<input class="design_inscription" type="text" name="pseudo" placeholder="Pseudo" minlength="2" maxlength="20" required />&nbsp;<br/> <br/>
    &nbsp;<input class="design_inscription" type="email" name="email" placeholder="Email" required />&nbsp;<br/> <br/>
    &nbsp;<input class="design_inscription" type="password" name="mdp" placeholder="Mot de passe" required />&nbsp;<br/> <br/>
    &nbsp;<input class="btndesign_inscription" type="submit" value="Valider"> <br/> <br/>
    </form>
</div>
</div>