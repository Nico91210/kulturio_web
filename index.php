...
<head>
    ...
    <link href="data/images/storytelling.png" rel="apple-touch-icon" />
    <link href="data/images/storytelling.png" rel="apple-touch-icon" sizes="76x76" />
    <link href="data/images/storytelling.png" rel="apple-touch-icon" sizes="120x120" />
    <link href="data/images/storytelling.png" rel="apple-touch-icon" sizes="152x152" />
    <link href="data/images/storytelling.png" rel="apple-touch-icon" sizes="180x180" />
    <link href="data/images/storytelling.png" rel="icon" sizes="192x192" />
    <link href="data/images/storytelling.png" rel="icon" sizes="128x128" />
</head>
...
<body>
    ...
    <div id="navbar">
        <ul id="ul-nav">
            ...
            <?php /*if (!empty($_SESSION)) {
                if ($_SESSION['user']['role'] === "admin") { ?>
                    <li class="list-nav">
                        <a href="questions_reponses.php">Questions Kulturio</a>
                    </li>
            <?php }
            } */ ?>
            <?php if(!empty($_SESSION))  {
        ...
        <?php }}?>
                ...
                <li class="list-nav">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <?php if (empty($_SESSION)) { ?>
                                <a href="compte/connexion_compte.php">Connexion</a>
                                <a href="compte/inscription.php">Inscription</a>
                            <?php } else { ?>
                                <a href="compte/parametres.php">Paramètres</a>
            ...
            <div class="tel">
                <?php if (empty($_SESSION)) { ?>
                    <li class="list-nav">
                        <a href="compte/connexion_compte.php">
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="40" height="40" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
                                <g>
                                    <g id="account-circle">
                                        <path d="M255,0C114.75,0,0,114.75,0,255s114.75,255,255,255s255-114.75,255-255S395.25,0,255,0z M255,76.5
    ...
    <div class="flexbox-index">
        <div class="flexbox-div-index">
            <h1>Kulturio</h1>
            <?php if (empty($_SESSION)) { ?>
                <a href="compte/connexion_compte.php"><img src="data/images/storytelling.png" width="20%" /></a>
            <?php } else { ?>
                <a href="#"><img src="data/images/storytelling.png" width="20%" /></a>
            <?php } ?>
            <?php if (empty($_SESSION)) { ?>
                <h2><a class="btn-flex-index" href="compte/connexion_compte.php">
                        &nbsp Connexion requise &nbsp
                    </a></h2>
            <?php } else { ?>
                <h2><a class="btn-flex-index" href="#">
                        &nbsp Coming Soon &nbsp
                    </a></h2>
            <?php } ?>
        </div>
        ...
        <div class="flexbox-div-index">
            <h1>Sampl'Quizz</h1>
            <?php if (empty($_SESSION)) { ?>
                <a href="compte/connexion_compte.php"><img src="data/images/cd.png" width="20%" /></a>
            <?php } else { ?>
                <a href="sampl/main.php"><img src="data/images/cd.png" width="20%" /></a>
            <?php } ?>
            <?php if (empty($_SESSION)) { ?>
                <h2><a class="btn-flex-index" href="compte/connexion_compte.php">
                        &nbsp Connexion requise &nbsp
            ...
            <?php } else { ?>
                <h2><a class="btn-flex-index" href="sampl/main.php">
                        &nbsp C'est Parti &nbsp
                    </a></h2>
            <?php } ?>
        </div>
    </div>
